...
import { formatCurrency, formatDate, formatNumber, getFullName, statusClasses } from "@/lib/deal-utils";
...
export default function ListingDetailPage() {
  ...
  if (loading || pageLoading || !user || !listing) return <LoadingScreen label="Loading listing detail..." />;
          ...
          <section className="panel overflow-hidden">
            ...
            <div className="p-6 lg:p-8">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="badge bg-brand-orange/10 text-brand-orange">{listing.deal_type}</span>
              </div>
          ...
          <section className="panel p-6">
            ...
            <div className="mt-4 space-y-3">
              {(listing.listing_documents || []).length ? (listing.listing_documents || []).map((document) => (
                <a key={document.id} href={document.public_url} target="_blank" className="subtle-panel block p-4 text-sm font-semibold text-brand-navy">
                  {document.file_name}
                </a>
